...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('genres.add') }}">Add</a></li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3 needs-validation mt-2" novalidate method="post" action="{{ route('genres.add') }}">
            @csrf
            <div class="col-md-6">
                <label for="genreName" class="form-label">Genre Name</label>
                <input type="text" class="form-control" name="genreName" id="genreName" value="{{ old('genreName', '') }}" required>
