...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('actors.add') }}">Add</a></li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3 needs-validation mt-2" novalidate method="post" action="{{ route('actors.add') }}">
            @csrf
            <div class="col-md-6">
                <label for="actorName" class="form-label">Actor Name</label>
                <input type="text" class="form-control" name="actorName" id="actorName" value="{{ old('actorName', '') }}" required>
