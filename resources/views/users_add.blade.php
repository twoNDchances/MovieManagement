...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('users.add') }}">Add</a></li>
    </ol>
</nav>
@endsection
...
@section('content')
@if ($permission)
<form class="row g-3 needs-validation" novalidate method="post" action="{{ route('users.add') }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        <div class="card-body mt-2">
            ...
            <div class="tab-content pt-2" id="myTabjustifiedContent">
                <div class="tab-pane fade show active" id="user-informations" role="tabpanel" aria-labelledby="informations-tab">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <input type="password" class="form-control" id="password" name="password" required min="8" value="{{ old('password', '') }}">
                            <div class="invalid-feedback">
                                Required
                            </div>
                ...
                <div class="tab-pane fade" id="user-permissions" role="tabpanel" aria-labelledby="permissions-tab">
                    <div class="row mt-2">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="movies[]" id="moviesAdd" value="add">
                                    <label class="form-check-label" for="moviesAdd">Add</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="movies[]" id="moviesList" value="list">
                                    <label class="form-check-label" for="moviesList">List</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="movies[]" id="moviesView" value="view">
                                    <label class="form-check-label" for="moviesView">View</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="movies[]" id="moviesUpdate" value="update">
                                    <label class="form-check-label" for="moviesUpdate">Update</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="movies[]" id="moviesDelete" value="delete">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="genres[]" id="genresAdd" value="add">
                                    <label class="form-check-label" for="genresAdd">Add</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="genres[]" id="genresList" value="list">
                                    <label class="form-check-label" for="genresList">List</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="genres[]" id="genresView" value="view">
                                    <label class="form-check-label" for="genresView">View</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="genres[]" id="genresUpdate" value="update">
                                    <label class="form-check-label" for="genresUpdate">Update</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="genres[]" id="genresDelete" value="delete">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="regions[]" id="regionsAdd" value="add">
                                    <label class="form-check-label" for="regionsAdd">Add</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="regions[]" id="regionsList" value="list">
                                    <label class="form-check-label" for="regionsList">List</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="regions[]" id="regionsView" value="view">
                                    <label class="form-check-label" for="regionsView">View</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="regions[]" id="regionsUpdate" value="update">
                                    <label class="form-check-label" for="regionsUpdate">Update</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="regions[]" id="regionsDelete" value="delete">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="actors[]" id="actorsAdd" value="add">
                                    <label class="form-check-label" for="actorsAdd">Add</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="actors[]" id="actorsList" value="list">
                                    <label class="form-check-label" for="actorsList">List</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="actors[]" id="actorsView" value="view">
                                    <label class="form-check-label" for="actorsView">View</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="actors[]" id="actorsUpdate" value="update">
                                    <label class="form-check-label" for="actorsUpdate">Update</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" checked name="actors[]" id="actorsDelete" value="delete">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" name="users[]" id="usersAdd" value="add">
                                    <label class="form-check-label" for="usersAdd">Add</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" name="users[]" id="usersList" value="list">
                                    <label class="form-check-label" for="usersList">List</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" name="users[]" id="usersView" value="view">
                                    <label class="form-check-label" for="usersView">View</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" name="users[]" id="usersUpdate" value="update">
                                    <label class="form-check-label" for="usersUpdate">Update</label>
                                </div>
                                <div class="col-md-2">
                                    <input class="form-check-input" type="checkbox" name="users[]" id="usersDelete" value="delete">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="row">
                                <div class="col-md-4">
                                    <input class="form-check-input" type="checkbox" checked name="others[]" id="othersLogin" value="login">
                                    <label class="form-check-label" for="othersLogin">Login Permitted</label>
                                </div>
                                <div class="col-md-4">
                                    <input class="form-check-input" type="checkbox" checked name="others[]" id="othersEditLogin" value="editLogin">
