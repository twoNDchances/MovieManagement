...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('regions.view', ['staticURL' => $staticURL]) }}">View</a></li>
    </ol>
</nav>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3 needs-validation mt-2" novalidate method="post" action="{{ route('regions.update', ['staticURL' => $staticURL]) }}">
            @csrf
            @method('PATCH')
            <div class="col-md-6">
                <label for="regionName" class="form-label">Region Name</label>
                <input type="text" class="form-control" name="regionName" id="regionName" value="{{ old('regionName', $regionName) }}" required>
            ...
            <div class="col-12">
                ...
                <a class="btn btn-link" type="button" id="backButton" href="{{ route('regions.page') }}">Back</a>
            </div>
